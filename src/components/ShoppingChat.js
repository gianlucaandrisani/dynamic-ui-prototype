...
import SendIcon from '../Forward.svg'; // Correctly import the SVG
      ...
      <div className='input-wrapper'>
        <div className="input-container">
          <div className='marketing'>
              Powered by <span className='highlight'>Skippr</span>
          </div>
          <input
            type="text"
            value={input}
          ...
          />
          <Button onClick={handleSend} Icon={SendIcon} className="input"/>
        </div>
      </div>
    </div>
  );
